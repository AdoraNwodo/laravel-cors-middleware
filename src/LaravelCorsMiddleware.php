...
class LaravelCorsMiddleware
{
    ...
    /*
     * A preflight request has the OPTIONS request. It also checks to see that the CORS protocol is understood
    ...
    /*
     * This function checks if the request is a CORS request
     *
     * @param \Illuminate\Http\Request  $request
     * @return boolean
     */
    ...
    /*
     * This function checks if the current origin is in the list of allowed origins
     *
     * @param \Illuminate\Http\Request  $request
     * @return boolean
     */
    ...
    /*
     * This function checks if the current origin is the same as the host
     *
     * @param \Illuminate\Http\Request  $request
     * @return boolean
     */
    ...
    public function handle($request, Closure $next)
    {
        ...
        foreach($this->headers as $key => $value)
        {
            ...
            if ($key = 'allowedOrigins') {	//pick the origin from the list of origins 
